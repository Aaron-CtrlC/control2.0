...
class Main_template
{
    ...
    {
        $main = '
    <main class="container d-flex justify-content-center align-items-center flex-column" style="margin-top:50px; width: 90vw; height: 70vh;">
<section class="bg-light rounded-3 d-flex flex-column justify-content-center align-items-center" style="width: 80vw; height: 70vh;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover text-center" id="mytable">
                                <thead class="table-light">
                                    <tr>
                                        <th class="bg-primary text-light" scope="col" style="width: 5%;">#</th>
                                        ...
                                        <th class="bg-primary text-light" scope="col" style="width: 10%;">Info</th>
                                    </tr>
                                </thead>
                                <tbody>';
        ...
        foreach ($this->listaAlumnos as $index => $alumno) {
            ...
            if ($tutor) {
                ...
                $main .= $this->modalInformeGeneral($idCurso);
            }
        }
    ...
    private function modalInformeGeneral($idCurso)
    {
        ...
        <div class="modal fade" id="modalInformeGeneral' . $idCurso . '" tabindex="-1" aria-labelledby="modalLabel' . $idCurso . '" aria-hidden="true">
            ...
            <div class="modal-header d-flex justify-content-between">
                    ...
                    <div class="modal-body">
                        ...
                        ' . $this->tableInformeCurso($idCurso) . '
                    </div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-square-fill" viewBox="0 0 16 16">
  <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm8.93 4.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533zM8 5.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
    ...
    private function tableInformeCurso($idCurso)
    {
        ...
        foreach ($faltaTotal as $informe) {
            ...
            <tr>
                ...
                <td>' . $informe->getAsistenciasCompletas() . '</td>
                <td>' . $informe->getAsistenciasMedias() . '</td>
                <td>' . $informe->getAsistenciasFaltas() . '</td>
            ...
            <table id="tableInformeCurso" class="table table-striped table-bordered table-hover align-middle">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col">Asistencias Medias</th>
  ...
  <path fill-rule="evenodd" d="M4.475 5.458c-.284 0-.514-.237-.47-.517C4.28 3.24 5.576 2 7.825 2c2.25 0 3.767 1.36 3.767 3.215 0 1.344-.665 2.288-1.79 2.973-1.1.659-1.414 1.118-1.414 2.01v.03a.5.5 0 0 1-.5.5h-.77a.5.5 0 0 1-.5-.495l-.003-.2c-.043-1.221.477-2.001 1.645-2.712 1.03-.632 1.397-1.135 1.397-2.028 0-.979-.758-1.698-1.926-1.698-1.009 0-1.71.529-1.938 1.402-.066.254-.278.461-.54.461h-.777ZM7.496 14c.622 0 1.095-.474 1.095-1.09 0-.618-.473-1.092-1.095-1.092-.606 0-1.087.474-1.087 1.091S6.89 14 7.496 14"/>
    ...
    private function modalInfoAsistencias($alumno)
    {
        ...
        echo '
            ...
            <div class="modal-dialog modal-lg custom-modal-dialog" style="max-width: 90%;"> <!-- Aumentando el tamaño con max-width -->
                    <div class="modal-content">
               <div class="modal-header d-flex justify-content-between">
                            <h5 class="modal-title" id="modalLabel' . $alumno->getId() . '">Información del Alumno ' . $alumno->getNombre() . ' ' . $alumno->getApellido() . '</h5>
                </div>
    ...
    private function tableAsistencia($idAlumno)
    {
        ...
        foreach ($listaFaltas as $falta) {
            $caption = '
                <div>
                    Asistencia completas: ' . $falta->getAsistenciasCompletas() . '<br>
                </div>
                <div>
                    medias Asistencias: ' . $falta->getAsistenciasMedias() . '<br>
                </div>
                <div>
                    faltas : ' . $falta->getAsistenciasFaltas() . '<br>
                </div>
                <div>
                    Faltas totales: ' . $falta->getTotalFaltas() . '<br>
                </div>
            ';
        }
        ...
        return '
            <div class="table-responsive" style="max-height: 400px; overflow-y: scroll; border: 1px solid #ddd; padding: 10px;">
                <table id="#InformeIndividual' . $idAlumno . 'l" class="table table-striped table-bordered table-hover align-middle">
                    <thead class="thead-light">
                        <tr>
