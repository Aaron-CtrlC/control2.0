...
<section class="bg-light rounded-3 d-flex flex-column justify-content-center align-items-center" style="width: 75vw; height: 85vh;">
    ...
    private function generateTableRow($index, $usuario): string
{
    ...
    // Inicializamos la variable $cursoAsignado
    $cursoAsignado = '';

    // Verificamos si el usuario tiene cursos asignados
    if (!empty($cursos)) {
