...
class Main_template
{
    ...
    {
        $main = '
    <main class="container d-flex justify-content-center align-items-center flex-column" style="margin-top:50px; width: 90vw; height: 100vh;">
<section class="bg-light rounded-3 d-flex flex-column justify-content-center align-items-center" style="width: 80vw; height: 90vh;">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover text-center "  style="width: 60vw; ">
    ...
    public function alumnosByIdCurso()
    {
